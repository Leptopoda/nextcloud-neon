...
Future run(final DockerImage image) async {
  group('notifications', () {
    ...
    test('List notifications', () async {
      ...
      expect(response.ocs.data[0].subjectRichParameters.builtMapStringObject, null);
      expect(response.ocs.data[0].messageRich, '');
      expect(response.ocs.data[0].messageRichParameters.builtMapStringObject, null);
    ...
    test('Get notification', () async {
      ...
      expect(response.ocs.data.subjectRichParameters.builtMapStringObject, null);
      expect(response.ocs.data.messageRich, '');
      expect(response.ocs.data.messageRichParameters.builtMapStringObject, null);
